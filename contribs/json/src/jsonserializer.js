 ...
 * Serializes data while iterating to a JSONLogger instance
 * You can share this class as it doesn't maintain state information between serializeData calls
 */
xtiger.editor.JSONSerializer = function (baseUrl) {
}

xtiger.editor.JSONSerializer.prototype = {
...
xtiger.editor.Generator.prototype.defaultSerializer = new xtiger.editor.JSONSerializer ();
